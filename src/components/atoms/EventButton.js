    ...
    return (
        <div className={combine(styles, 'component')}>
            <div className={combine(styles, 'icon')}>
                <FontAwesomeIcon icon={faCalendarPlus} color={Colors.primaryLight} />
            </div>
            <div className={combine(styles, 'tooltip')}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Spacer size={24} />
                    <TextArea label='Description' placeholder='Tell others about it' />
                    <Spacer size={24} />
                    <Input label='Location' placeholder='Tell about the place' />
                    <Spacer size={24} />
