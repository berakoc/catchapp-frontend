...
export const deepCompare = (o1, o2) => {
    ...
    for (const key of o1Keys) {
        ...
        else if (typeof o1[key] === 'object') isEqual = isEqual && deepCompare(o1[key], o2[key])
        else if (!Object.is(o1[key], o2[key])) isEqual = false
    }
    return isEqual
}

export const compareProp = (name, key) => (prevProps, nextProps) => prevProps[name][key] === nextProps[name][key]